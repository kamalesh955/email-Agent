...
├── saved_results.json      # Stored drafts and analyses
...
- **Google Generative AI (Gemini)** - LLM for processing
...
**Kamalesh**
- GitHub: [@kamalesh955](https://github.com/kamalesh955)

## 🤝 Contributing

Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/kamalesh955/email-Agent/issues).
